...
public class TestMathEvaluator {
  ...
  public void infixStringToStack() {
    ...
    shortStack1.push("+");
    shortStack1.push("3");
    assertEquals(shortStack1, math.infixStringToArrayList("8 + 3"));
    Stack<String> shortStack2 = new Stack<>();
    shortStack2.push("6");
    shortStack2.push("-");
    shortStack2.push("2");
    assertEquals(shortStack2, math.infixStringToArrayList("6 - 2"));
    Stack<String> shortStack3 = new Stack<>();
    shortStack3.push("9");
    shortStack3.push("/");
    shortStack3.push("3");
    assertEquals(shortStack3, math.infixStringToArrayList("9 / 3"));
    Stack<String> shortStack4 = new Stack<>();
    shortStack4.push("7");
    shortStack4.push("*");
    shortStack4.push("4");
    assertEquals(shortStack4, math.infixStringToArrayList("7 * 4"));
    ...
    shortStack5.push("2");
    shortStack5.push("+");
    assertNotEquals(shortStack5, math.infixStringToArrayList("4 + 2"));
    Stack<String> shortStack6 = new Stack<>();
    shortStack6.push("5");
    shortStack6.push("0");
    shortStack6.push("-");
    assertNotEquals(shortStack6, math.infixStringToArrayList("5 - 0"));
    ...
    assertEquals(twoDigitStack1, math.infixStringToArrayList("21 / 7 + 37"));
    ...
    assertEquals(twoDigitStack2, math.infixStringToArrayList("9 + 15 - 1 * 2"));
    ...
    assertEquals(twoDigitStack3, math.infixStringToArrayList("20 / 10 * 11 + 91"));
  ...
  @Test
  public void infixToPostfixStack() {
    //A: test simple infix to postfix
    Stack<String> simpleInfix1 = new Stack<>();
    simpleInfix1.push("1");
    simpleInfix1.push("+");
    simpleInfix1.push("2");
    Stack<String> simplePostfix1 = new Stack<>();
    simplePostfix1.push("1");
    simplePostfix1.push("2");
    simplePostfix1.push("+");
    assertEquals(simplePostfix1, math.infixToPostfixStack(simpleInfix1));
  }
